...
//29
console.log("\n ex 29 \n");
const favorite_fruits = ["mango", "apple", "watermelon"];
const checkFruit = "mango";
...
//32 finding user
console.log("\n ex 32 \n");
const currentUsers = ["talha", "Arif", "Ilyas"];
const newUsers = ["TALHA", "ARIF", "babar", "Moin"];
...
//34 pizzas
console.log("\n ex 34 \n");
const favPizzas = ["Malai boti", "Chiken fajita", "Behari kabab"];
